...
urlpatterns += patterns('app.people.views',
    ...
    url(r'^people/associations/people/(?P<pk>\d+)/update/$', UpdatePersonAssociatedPerson.as_view(), name='persontoperson-update'),
    url(r'^people/(?P<person_id>\d+)/associations/people/add/$', AddPersonAssociatedPerson.as_view(), name='persontoperson-add'),
    url(r'^people/associations/people/(?P<pk>\d+)/delete/$', DeletePersonAssociatedPerson.as_view(), name='persontoperson-delete'),

    url(r'^people/associations/organisations/(?P<pk>\d+)/update/$', UpdatePersonAssociatedOrganisation.as_view(), name='personorganisation-update'),
    url(r'^people/(?P<person_id>\d+)/associations/organisations/add/$', AddPersonAssociatedOrganisation.as_view(), name='personorganisation-add'),
    url(r'^people/associations/organisations/(?P<pk>\d+)/delete/$', DeletePersonAssociatedOrganisation.as_view(), name='personorganisation-delete'),
