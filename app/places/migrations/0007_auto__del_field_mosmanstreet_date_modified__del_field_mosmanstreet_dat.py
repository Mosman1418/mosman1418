...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MosmanStreet.date_modified'
        db.delete_column('places_mosmanstreet', 'date_modified')

        # Deleting field 'MosmanStreet.date_created'
        db.delete_column('places_mosmanstreet', 'date_created')

        # Deleting field 'MosmanStreet.added_by'
        db.delete_column('places_mosmanstreet', 'added_by_id')


    def backwards(self, orm):
        # Adding field 'MosmanStreet.date_modified'
        db.add_column('places_mosmanstreet', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 4, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'MosmanStreet.date_created'
        db.add_column('places_mosmanstreet', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'MosmanStreet.added_by'
        db.add_column('places_mosmanstreet', 'added_by',
