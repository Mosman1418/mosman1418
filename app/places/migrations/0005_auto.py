...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sources on 'Place'
        db.create_table('places_place_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('place', models.ForeignKey(orm['places.place'], null=False)),
            ('source', models.ForeignKey(orm['sources.source'], null=False))
        ))
        db.create_unique('places_place_sources', ['place_id', 'source_id'])


    def backwards(self, orm):
        # Removing M2M table for field sources on 'Place'
        db.delete_table('places_place_sources')
