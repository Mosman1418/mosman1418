...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.display_name'
        db.alter_column('places_place', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Place.geonames_id'
        db.alter_column('places_place', 'geonames_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Place.display_name'
        db.alter_column('places_place', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Place.geonames_id'
        db.alter_column('places_place', 'geonames_id', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
