...
from mosman1418.places.models import Place
from mosman1418.people.models import Person, Organisation
from mosman1418.events.models import Event
from mosman1418.objects.models import Object
from mosman1418.sources.models import Source
...
class MemorialAssociatedSource(models.Model):
    ...
    def __unicode__(self):
        return '%s: %s (%s)' % (self.association, self.source, self.source.source_type)
