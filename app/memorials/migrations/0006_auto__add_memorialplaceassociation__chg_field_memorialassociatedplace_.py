...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MemorialPlaceAssociation'
        db.create_table('memorials_memorialplaceassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('memorials', ['MemorialPlaceAssociation'])

        # Adding M2M table for field rdf_property on 'MemorialPlaceAssociation'
        db.create_table('memorials_memorialplaceassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('memorialplaceassociation', models.ForeignKey(orm['memorials.memorialplaceassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('memorials_memorialplaceassociation_rdf_property', ['memorialplaceassociation_id', 'rdfproperty_id'])


        # Changing field 'MemorialAssociatedPlace.association'
        db.alter_column('memorials_memorialassociatedplace', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memorials.MemorialPlaceAssociation']))

    def backwards(self, orm):
        # Deleting model 'MemorialPlaceAssociation'
        db.delete_table('memorials_memorialplaceassociation')

        # Removing M2M table for field rdf_property on 'MemorialPlaceAssociation'
        db.delete_table('memorials_memorialplaceassociation_rdf_property')


        # Changing field 'MemorialAssociatedPlace.association'
        db.alter_column('memorials_memorialassociatedplace', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memorials.MemorialAssociation']))
    ...
    models = {
        ...
        'memorials.memorial': {
            ...
            'address': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['places.Address']", 'null': 'True', 'blank': 'True'}),
