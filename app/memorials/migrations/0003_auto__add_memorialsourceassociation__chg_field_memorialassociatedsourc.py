...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MemorialSourceAssociation'
        db.create_table('memorials_memorialsourceassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('memorials', ['MemorialSourceAssociation'])

        # Adding M2M table for field rdf_property on 'MemorialSourceAssociation'
        db.create_table('memorials_memorialsourceassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('memorialsourceassociation', models.ForeignKey(orm['memorials.memorialsourceassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('memorials_memorialsourceassociation_rdf_property', ['memorialsourceassociation_id', 'rdfproperty_id'])


        # Changing field 'MemorialAssociatedSource.association'
        db.alter_column('memorials_memorialassociatedsource', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memorials.MemorialSourceAssociation']))

    def backwards(self, orm):
        # Deleting model 'MemorialSourceAssociation'
        db.delete_table('memorials_memorialsourceassociation')

        # Removing M2M table for field rdf_property on 'MemorialSourceAssociation'
        db.delete_table('memorials_memorialsourceassociation_rdf_property')


        # Changing field 'MemorialAssociatedSource.association'
        db.alter_column('memorials_memorialassociatedsource', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memorials.MemorialAssociation']))
