...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemorialName.notes'
        db.add_column('memorials_memorialname', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemorialName.notes'
        db.delete_column('memorials_memorialname', 'notes')
