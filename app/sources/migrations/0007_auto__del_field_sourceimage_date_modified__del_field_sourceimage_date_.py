...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SourceImage.date_modified'
        db.delete_column('sources_sourceimage', 'date_modified')

        # Deleting field 'SourceImage.date_created'
        db.delete_column('sources_sourceimage', 'date_created')

        # Deleting field 'SourceImage.added_by'
        db.delete_column('sources_sourceimage', 'added_by_id')


    def backwards(self, orm):
        # Adding field 'SourceImage.date_modified'
        db.add_column('sources_sourceimage', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 4, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SourceImage.date_created'
        db.add_column('sources_sourceimage', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SourceImage.added_by'
        db.add_column('sources_sourceimage', 'added_by',
