...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.repository'
        db.alter_column('sources_source', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Repository'], null=True))

    def backwards(self, orm):

        # Changing field 'Source.repository'
        db.alter_column('sources_source', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['people.Organisation']))
