...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceImage.transcript'
        db.add_column('sources_sourceimage', 'transcript',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source.caption'
        db.add_column('sources_source', 'caption',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Story.credit'
        db.add_column('sources_story', 'credit',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceImage.transcript'
        db.delete_column('sources_sourceimage', 'transcript')

        # Deleting field 'Source.caption'
        db.delete_column('sources_source', 'caption')

        # Deleting field 'Story.credit'
        db.delete_column('sources_story', 'credit')
