...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sources_source', 'source_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sources.SourceType'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Source.source_type'
        db.alter_column('sources_source', 'source_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['sources.SourceType']))
