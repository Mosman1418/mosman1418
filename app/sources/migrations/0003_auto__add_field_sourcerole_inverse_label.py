...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SourceRole.inverse_label'
        db.add_column('sources_sourcerole', 'inverse_label',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SourceRole.inverse_label'
        db.delete_column('sources_sourcerole', 'inverse_label')
