...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Death.cause_of_death'
        db.add_column('people_death', 'cause_of_death',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Death.burial_place'
        db.add_column('people_death', 'burial_place',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='burial_place', null=True, to=orm['places.Place']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Death.cause_of_death'
        db.delete_column('people_death', 'cause_of_death')

        # Deleting field 'Death.burial_place'
        db.delete_column('people_death', 'burial_place_id')
