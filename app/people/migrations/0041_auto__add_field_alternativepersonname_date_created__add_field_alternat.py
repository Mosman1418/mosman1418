...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlternativePersonName.date_created'
        db.add_column('people_alternativepersonname', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'AlternativePersonName.date_modified'
        db.add_column('people_alternativepersonname', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'AlternativePersonName.added_by'
        db.add_column('people_alternativepersonname', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlternativePersonName.date_created'
        db.delete_column('people_alternativepersonname', 'date_created')

        # Deleting field 'AlternativePersonName.date_modified'
        db.delete_column('people_alternativepersonname', 'date_modified')

        # Deleting field 'AlternativePersonName.added_by'
        db.delete_column('people_alternativepersonname', 'added_by_id')
