...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sources on 'PersonAssociatedPerson'
        db.create_table('people_personassociatedperson_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personassociatedperson', models.ForeignKey(orm['people.personassociatedperson'], null=False)),
            ('source', models.ForeignKey(orm['sources.source'], null=False))
        ))
        db.create_unique('people_personassociatedperson_sources', ['personassociatedperson_id', 'source_id'])


        # Changing field 'PersonAssociatedPerson.associated_person'
        db.alter_column('people_personassociatedperson', 'associated_person_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['people.Person']))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sources on 'PersonAssociatedPerson'
        db.delete_table('people_personassociatedperson_sources')


        # Changing field 'PersonAssociatedPerson.associated_person'
        db.alter_column('people_personassociatedperson', 'associated_person_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['people.Person']))
