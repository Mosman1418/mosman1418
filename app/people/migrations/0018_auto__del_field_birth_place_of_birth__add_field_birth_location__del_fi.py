...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Birth.place_of_birth'
        db.delete_column('people_birth', 'place_of_birth_id')

        # Adding field 'Birth.location'
        db.add_column('people_birth', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Death.place_of_death'
        db.delete_column('people_death', 'place_of_death_id')

        # Adding field 'Death.location'
        db.add_column('people_death', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Birth.place_of_birth'
        db.add_column('people_birth', 'place_of_birth',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Birth.location'
        db.delete_column('people_birth', 'location_id')

        # Adding field 'Death.place_of_death'
        db.add_column('people_death', 'place_of_death',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Death.location'
        db.delete_column('people_death', 'location_id')
