...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organisation.display_name'
        db.alter_column('people_organisation', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Repository.display_name'
        db.alter_column('people_repository', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Organisation.display_name'
        db.alter_column('people_organisation', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Repository.display_name'
        db.alter_column('people_repository', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        'memorials.memorialassociatedplace': {
            ...
            'association': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['memorials.MemorialPlaceAssociation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'memorial': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['memorials.Memorial']"}),
        ...
        'memorials.memorialplaceassociation': {
            'Meta': {'object_name': 'MemorialPlaceAssociation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'rdf_property': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['linkeddata.RDFProperty']", 'symmetrical': 'False', 'blank': 'True'})
        },
        ...
        'people.alternativepersonname': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'memorials': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['memorials.Memorial']", 'null': 'True', 'blank': 'True'}),
        ...
        'people.death': {
            ...
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'burial_place': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'burial_place'", 'null': 'True', 'to': "orm['places.Place']"}),
        ...
        'people.organisation': {
            ...
            'end_earliest_month': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'merged_into': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Organisation']", 'null': 'True', 'blank': 'True'}),
        ...
        'people.person': {
            ...
            'last_rank': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'merged_into': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']", 'null': 'True', 'blank': 'True'}),
        ...
        'people.servicenumber': {
            'Meta': {'object_name': 'ServiceNumber'},
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']"}),
            'service_number': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sources': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sources.Source']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'places.address': {
            'Meta': {'ordering': "['street_name', 'mosman_street__street_name', 'street_number']", 'object_name': 'Address'},
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
        ...
        'places.place': {
            'Meta': {'ordering': "['place_name']", 'object_name': 'Place'},
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'geonames_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'lon': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'merged_into': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Place']", 'null': 'True', 'blank': 'True'}),
