...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeopleStory.earliest_date'
        db.add_column('people_peoplestory', 'earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PeopleStory.earliest_month_known'
        db.add_column('people_peoplestory', 'earliest_month_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeopleStory.earliest_day_known'
        db.add_column('people_peoplestory', 'earliest_day_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeopleStory.latest_date'
        db.add_column('people_peoplestory', 'latest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PeopleStory.latest_month_known'
        db.add_column('people_peoplestory', 'latest_month_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeopleStory.latest_day_known'
        db.add_column('people_peoplestory', 'latest_day_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeopleStory.earliest_date'
        db.delete_column('people_peoplestory', 'earliest_date')

        # Deleting field 'PeopleStory.earliest_month_known'
        db.delete_column('people_peoplestory', 'earliest_month_known')

        # Deleting field 'PeopleStory.earliest_day_known'
        db.delete_column('people_peoplestory', 'earliest_day_known')

        # Deleting field 'PeopleStory.latest_date'
        db.delete_column('people_peoplestory', 'latest_date')

        # Deleting field 'PeopleStory.latest_month_known'
        db.delete_column('people_peoplestory', 'latest_month_known')

        # Deleting field 'PeopleStory.latest_day_known'
        db.delete_column('people_peoplestory', 'latest_day_known')
