...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field memorials on 'AlternativePersonName'
        db.create_table('people_alternativepersonname_memorials', (
        ...
        db.create_unique('people_alternativepersonname_memorials', ['alternativepersonname_id', 'memorial_id'])


    def backwards(self, orm):
        # Removing M2M table for field memorials on 'AlternativePersonName'
        db.delete_table('people_alternativepersonname_memorials')
