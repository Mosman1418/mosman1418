...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_organisation', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Organisation.date_modified'
        db.add_column('people_organisation', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Organisation.added_by'
        db.add_column('people_organisation', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Organisation.start_earliest_date'
        db.add_column('people_organisation', 'start_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organisation.start_earliest_month'
        db.add_column('people_organisation', 'start_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Organisation.start_earliest_day'
        db.add_column('people_organisation', 'start_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Organisation.end_earliest_date'
        db.add_column('people_organisation', 'end_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organisation.end_earliest_month'
        db.add_column('people_organisation', 'end_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Organisation.end_earliest_day'
        db.add_column('people_organisation', 'end_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Organisation.display_name'
        db.add_column('people_organisation', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='organisation', max_length=200),
                      keep_default=False)

        # Adding field 'Organisation.description'
        db.add_column('people_organisation', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.start_earliest_date'
        db.add_column('people_repository', 'start_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.start_earliest_month'
        db.add_column('people_repository', 'start_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repository.start_earliest_day'
        db.add_column('people_repository', 'start_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repository.end_earliest_date'
        db.add_column('people_repository', 'end_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.end_earliest_month'
        db.add_column('people_repository', 'end_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repository.end_earliest_day'
        db.add_column('people_repository', 'end_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('people_organisation', 'date_created')

        # Deleting field 'Organisation.date_modified'
        db.delete_column('people_organisation', 'date_modified')

        # Deleting field 'Organisation.added_by'
        db.delete_column('people_organisation', 'added_by_id')

        # Deleting field 'Organisation.start_earliest_date'
        db.delete_column('people_organisation', 'start_earliest_date')

        # Deleting field 'Organisation.start_earliest_month'
        db.delete_column('people_organisation', 'start_earliest_month')

        # Deleting field 'Organisation.start_earliest_day'
        db.delete_column('people_organisation', 'start_earliest_day')

        # Deleting field 'Organisation.end_earliest_date'
        db.delete_column('people_organisation', 'end_earliest_date')

        # Deleting field 'Organisation.end_earliest_month'
        db.delete_column('people_organisation', 'end_earliest_month')

        # Deleting field 'Organisation.end_earliest_day'
        db.delete_column('people_organisation', 'end_earliest_day')

        # Deleting field 'Organisation.display_name'
        db.delete_column('people_organisation', 'display_name')

        # Deleting field 'Organisation.description'
        db.delete_column('people_organisation', 'description')

        # Deleting field 'Repository.start_earliest_date'
        db.delete_column('people_repository', 'start_earliest_date')

        # Deleting field 'Repository.start_earliest_month'
        db.delete_column('people_repository', 'start_earliest_month')

        # Deleting field 'Repository.start_earliest_day'
        db.delete_column('people_repository', 'start_earliest_day')

        # Deleting field 'Repository.end_earliest_date'
        db.delete_column('people_repository', 'end_earliest_date')

        # Deleting field 'Repository.end_earliest_month'
        db.delete_column('people_repository', 'end_earliest_month')

        # Deleting field 'Repository.end_earliest_day'
        db.delete_column('people_repository', 'end_earliest_day')
