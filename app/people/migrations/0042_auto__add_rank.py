...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('people_rank', (
            ...
            ('start_earliest_month', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('start_earliest_day', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('end_earliest_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_earliest_month', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('end_earliest_day', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'])),
            ('rank', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('people', ['Rank'])

        # Adding M2M table for field sources on 'Rank'
        db.create_table('people_rank_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rank', models.ForeignKey(orm['people.rank'], null=False)),
            ('source', models.ForeignKey(orm['sources.source'], null=False))
        ))
        db.create_unique('people_rank_sources', ['rank_id', 'source_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sources on 'Rank'
        db.delete_table('people_rank_sources')
