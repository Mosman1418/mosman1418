...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field memorials on 'PersonAssociatedOrganisation'
        db.create_table('people_personassociatedorganisation_memorials', (
        ...
        db.create_unique('people_personassociatedorganisation_memorials', ['personassociatedorganisation_id', 'memorial_id'])


    def backwards(self, orm):
        # Removing M2M table for field memorials on 'PersonAssociatedOrganisation'
        db.delete_table('people_personassociatedorganisation_memorials')
