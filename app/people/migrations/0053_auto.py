...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field memorials on 'LifeEvent'
        db.create_table('people_lifeevent_memorials', (
        ...
        db.create_unique('people_lifeevent_memorials', ['lifeevent_id', 'memorial_id'])


    def backwards(self, orm):
        # Removing M2M table for field memorials on 'LifeEvent'
        db.delete_table('people_lifeevent_memorials')
