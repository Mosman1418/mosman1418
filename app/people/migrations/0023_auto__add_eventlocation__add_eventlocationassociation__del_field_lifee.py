...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('people_eventlocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lifeevent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.LifeEvent'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'])),
            ('association', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.EventLocationAssociation'])),
        ))
        db.send_create_signal('people', ['EventLocation'])

        # Adding model 'EventLocationAssociation'
        db.create_table('people_eventlocationassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('people', ['EventLocationAssociation'])

        # Adding M2M table for field rdf_property on 'EventLocationAssociation'
        db.create_table('people_eventlocationassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventlocationassociation', models.ForeignKey(orm['people.eventlocationassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('people_eventlocationassociation_rdf_property', ['eventlocationassociation_id', 'rdfproperty_id'])

        # Deleting field 'LifeEvent.location'
        db.delete_column('people_lifeevent', 'location_id')


    def backwards(self, orm):
        # Deleting model 'EventLocation'
        db.delete_table('people_eventlocation')

        # Deleting model 'EventLocationAssociation'
        db.delete_table('people_eventlocationassociation')

        # Removing M2M table for field rdf_property on 'EventLocationAssociation'
        db.delete_table('people_eventlocationassociation_rdf_property')

        # Adding field 'LifeEvent.location'
        db.add_column('people_lifeevent', 'location',
    ...
    models = {
        ...
        'people.eventlocation': {
            ...
            'association': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.EventLocationAssociation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lifeevent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.LifeEvent']"}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Place']"})
        },
