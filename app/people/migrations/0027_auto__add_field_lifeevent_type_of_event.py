...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LifeEvent.type_of_event'
        db.add_column('people_lifeevent', 'type_of_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.LifeEventType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LifeEvent.type_of_event'
        db.delete_column('people_lifeevent', 'type_of_event_id')
