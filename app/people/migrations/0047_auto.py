...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field stories on 'Organisation'
        db.create_table('people_organisation_stories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organisation', models.ForeignKey(orm['people.organisation'], null=False)),
            ('story', models.ForeignKey(orm['sources.story'], null=False))
        ))
        db.create_unique('people_organisation_stories', ['organisation_id', 'story_id'])
        ...
        db.create_unique('people_person_stories', ['person_id', 'story_id'])


    def backwards(self, orm):
        # Removing M2M table for field stories on 'Organisation'
        db.delete_table('people_organisation_stories')
