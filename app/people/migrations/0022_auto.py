...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sources on 'AlternativePersonName'
        db.create_table('people_alternativepersonname_sources', (
        ...
        db.create_unique('people_alternativepersonname_sources', ['alternativepersonname_id', 'source_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sources on 'AlternativePersonName'
        db.delete_table('people_alternativepersonname_sources')
