...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonOrgAssociation'
        db.create_table('people_personorgassociation', (
        ...
        db.send_create_signal('people', ['PersonOrgAssociation'])

        # Adding M2M table for field rdf_property on 'PersonOrgAssociation'
        db.create_table('people_personorgassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personorgassociation', models.ForeignKey(orm['people.personorgassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('people_personorgassociation_rdf_property', ['personorgassociation_id', 'rdfproperty_id'])


        # Changing field 'PersonAssociatedOrganisation.association'
        db.alter_column('people_personassociatedorganisation', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.PersonOrgAssociation'], null=True))

    def backwards(self, orm):
        # Deleting model 'PersonOrgAssociation'
        db.delete_table('people_personorgassociation')

        # Removing M2M table for field rdf_property on 'PersonOrgAssociation'
        db.delete_table('people_personorgassociation_rdf_property')


        # Changing field 'PersonAssociatedOrganisation.association'
        db.alter_column('people_personassociatedorganisation', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.OrgAssociation'], null=True))
