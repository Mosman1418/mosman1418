...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.merged_into'
        db.add_column('people_organisation', 'merged_into',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Organisation'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field images on 'Organisation'
        db.delete_table('people_organisation_images')


    def backwards(self, orm):
        # Deleting field 'Organisation.merged_into'
        db.delete_column('people_organisation', 'merged_into_id')

        # Adding M2M table for field images on 'Organisation'
        db.create_table('people_organisation_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organisation', models.ForeignKey(orm['people.organisation'], null=False)),
            ('peopleimage', models.ForeignKey(orm['people.peopleimage'], null=False))
        ))
        db.create_unique('people_organisation_images', ['organisation_id', 'peopleimage_id'])
