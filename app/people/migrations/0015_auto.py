...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sources on 'LifeEvent'
        db.create_table('people_lifeevent_sources', (
        ...
        db.create_unique('people_lifeevent_sources', ['lifeevent_id', 'source_id'])


    def backwards(self, orm):
        # Removing M2M table for field sources on 'LifeEvent'
        db.delete_table('people_lifeevent_sources')
