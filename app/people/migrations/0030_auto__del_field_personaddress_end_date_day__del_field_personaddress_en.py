...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonAddress.end_date_day'
        db.delete_column('people_personaddress', 'end_date_day')

        # Deleting field 'PersonAddress.end_date'
        db.delete_column('people_personaddress', 'end_date')

        # Deleting field 'PersonAddress.start_date_day'
        db.delete_column('people_personaddress', 'start_date_day')

        # Deleting field 'PersonAddress.end_date_month'
        db.delete_column('people_personaddress', 'end_date_month')

        # Deleting field 'PersonAddress.start_date_month'
        db.delete_column('people_personaddress', 'start_date_month')

        # Deleting field 'PersonAddress.start_date'
        db.delete_column('people_personaddress', 'start_date')

        # Adding field 'PersonAddress.start_earliest_date'
        db.add_column('people_personaddress', 'start_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAddress.start_earliest_month'
        db.add_column('people_personaddress', 'start_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAddress.start_earliest_day'
        db.add_column('people_personaddress', 'start_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAddress.end_earliest_date'
        db.add_column('people_personaddress', 'end_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAddress.end_earliest_month'
        db.add_column('people_personaddress', 'end_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAddress.end_earliest_day'
        db.add_column('people_personaddress', 'end_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PersonAddress.end_date_day'
        db.add_column('people_personaddress', 'end_date_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAddress.end_date'
        db.add_column('people_personaddress', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAddress.start_date_day'
        db.add_column('people_personaddress', 'start_date_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAddress.end_date_month'
        db.add_column('people_personaddress', 'end_date_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAddress.start_date_month'
        db.add_column('people_personaddress', 'start_date_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAddress.start_date'
        db.add_column('people_personaddress', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PersonAddress.start_earliest_date'
        db.delete_column('people_personaddress', 'start_earliest_date')

        # Deleting field 'PersonAddress.start_earliest_month'
        db.delete_column('people_personaddress', 'start_earliest_month')

        # Deleting field 'PersonAddress.start_earliest_day'
        db.delete_column('people_personaddress', 'start_earliest_day')

        # Deleting field 'PersonAddress.end_earliest_date'
        db.delete_column('people_personaddress', 'end_earliest_date')

        # Deleting field 'PersonAddress.end_earliest_month'
        db.delete_column('people_personaddress', 'end_earliest_month')

        # Deleting field 'PersonAddress.end_earliest_day'
        db.delete_column('people_personaddress', 'end_earliest_day')
