...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_repository', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)

        # Adding field 'Repository.short_name'
        db.add_column('people_repository', 'short_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('people_repository', 'name')

        # Deleting field 'Repository.short_name'
        db.delete_column('people_repository', 'short_name')
