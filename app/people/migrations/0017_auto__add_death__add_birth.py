...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('people_death', (
            ...
            ('place_of_death', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True)),
        ))
        db.send_create_signal('people', ['Death'])

        # Adding M2M table for field sources on 'Death'
        db.create_table('people_death_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('death', models.ForeignKey(orm['people.death'], null=False)),
            ('source', models.ForeignKey(orm['sources.source'], null=False))
        ))
        db.create_unique('people_death_sources', ['death_id', 'source_id'])
        ...
        db.create_table('people_birth', (
            ...
            ('end_latest_day_known', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'])),
            ('place_of_birth', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place'], null=True, blank=True)),
        ))
        db.send_create_signal('people', ['Birth'])

        # Adding M2M table for field sources on 'Birth'
        db.create_table('people_birth_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('birth', models.ForeignKey(orm['people.birth'], null=False)),
            ('source', models.ForeignKey(orm['sources.source'], null=False))
        ))
        db.create_unique('people_birth_sources', ['birth_id', 'source_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sources on 'Death'
        db.delete_table('people_death_sources')

        # Deleting model 'Birth'
        db.delete_table('people_birth')

        # Removing M2M table for field sources on 'Birth'
        db.delete_table('people_birth_sources')
    ...
    models = {
        ...
        'people.birth': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']"}),
            'place_of_birth': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Place']", 'null': 'True', 'blank': 'True'}),
        ...
        'people.death': {
            ...
            'label': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']"}),
            'place_of_death': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['places.Place']", 'null': 'True', 'blank': 'True'}),
            'sources': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sources.Source']", 'null': 'True', 'blank': 'True'}),
            'start_earliest_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'start_earliest_day_known': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'start_earliest_month_known': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
