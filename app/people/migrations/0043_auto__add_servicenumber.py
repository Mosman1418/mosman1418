...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServiceNumber'
        db.create_table('people_servicenumber', (
            ...
            ('service_number', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('people', ['ServiceNumber'])

        # Adding M2M table for field sources on 'ServiceNumber'
        db.create_table('people_servicenumber_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('servicenumber', models.ForeignKey(orm['people.servicenumber'], null=False)),
            ('source', models.ForeignKey(orm['sources.source'], null=False))
        ))
        db.create_unique('people_servicenumber_sources', ['servicenumber_id', 'source_id'])


    def backwards(self, orm):
        # Deleting model 'ServiceNumber'
        db.delete_table('people_servicenumber')

        # Removing M2M table for field sources on 'ServiceNumber'
        db.delete_table('people_servicenumber_sources')
