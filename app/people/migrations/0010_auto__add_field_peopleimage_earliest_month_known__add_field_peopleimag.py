...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeopleImage.earliest_month_known'
        db.add_column('people_peopleimage', 'earliest_month_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeopleImage.earliest_day_known'
        db.add_column('people_peopleimage', 'earliest_day_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeopleImage.latest_month_known'
        db.add_column('people_peopleimage', 'latest_month_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PeopleImage.latest_day_known'
        db.add_column('people_peopleimage', 'latest_day_known',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeopleImage.earliest_month_known'
        db.delete_column('people_peopleimage', 'earliest_month_known')

        # Deleting field 'PeopleImage.earliest_day_known'
        db.delete_column('people_peopleimage', 'earliest_day_known')

        # Deleting field 'PeopleImage.latest_month_known'
        db.delete_column('people_peopleimage', 'latest_month_known')

        # Deleting field 'PeopleImage.latest_day_known'
        db.delete_column('people_peopleimage', 'latest_day_known')
