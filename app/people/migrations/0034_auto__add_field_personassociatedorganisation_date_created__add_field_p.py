...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAssociatedOrganisation.date_created'
        db.add_column('people_personassociatedorganisation', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedOrganisation.date_modified'
        db.add_column('people_personassociatedorganisation', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedOrganisation.added_by'
        db.add_column('people_personassociatedorganisation', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonAssociatedOrganisation.date_created'
        db.delete_column('people_personassociatedorganisation', 'date_created')

        # Deleting field 'PersonAssociatedOrganisation.date_modified'
        db.delete_column('people_personassociatedorganisation', 'date_modified')

        # Deleting field 'PersonAssociatedOrganisation.added_by'
        db.delete_column('people_personassociatedorganisation', 'added_by_id')
