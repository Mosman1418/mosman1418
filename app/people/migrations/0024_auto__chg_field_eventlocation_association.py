...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventLocation.association'
        db.alter_column('people_eventlocation', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.EventLocationAssociation'], null=True))

    def backwards(self, orm):

        # Changing field 'EventLocation.association'
        db.alter_column('people_eventlocation', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['people.EventLocationAssociation']))
