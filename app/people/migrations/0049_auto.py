...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field memorials on 'Rank'
        db.create_table('people_rank_memorials', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rank', models.ForeignKey(orm['people.rank'], null=False)),
            ('memorial', models.ForeignKey(orm['memorials.memorial'], null=False))
        ))
        db.create_unique('people_rank_memorials', ['rank_id', 'memorial_id'])

        # Adding M2M table for field memorials on 'Death'
        db.create_table('people_death_memorials', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('death', models.ForeignKey(orm['people.death'], null=False)),
            ('memorial', models.ForeignKey(orm['memorials.memorial'], null=False))
        ))
        db.create_unique('people_death_memorials', ['death_id', 'memorial_id'])


    def backwards(self, orm):
        # Removing M2M table for field memorials on 'Rank'
        db.delete_table('people_rank_memorials')

        # Removing M2M table for field memorials on 'Death'
        db.delete_table('people_death_memorials')
