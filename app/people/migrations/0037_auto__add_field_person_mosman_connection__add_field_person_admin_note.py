...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.mosman_connection'
        db.add_column('people_person', 'mosman_connection',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.admin_note'
        db.add_column('people_person', 'admin_note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.mosman_connection'
        db.delete_column('people_person', 'mosman_connection')

        # Deleting field 'Person.admin_note'
        db.delete_column('people_person', 'admin_note')
