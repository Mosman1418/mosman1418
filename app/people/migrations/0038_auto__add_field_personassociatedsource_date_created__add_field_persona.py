...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAssociatedSource.date_created'
        db.add_column('people_personassociatedsource', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedSource.date_modified'
        db.add_column('people_personassociatedsource', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedSource.added_by'
        db.add_column('people_personassociatedsource', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PersonAddress.date_created'
        db.add_column('people_personaddress', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAddress.date_modified'
        db.add_column('people_personaddress', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAddress.added_by'
        db.add_column('people_personaddress', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EventLocation.date_created'
        db.add_column('people_eventlocation', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'EventLocation.date_modified'
        db.add_column('people_eventlocation', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'EventLocation.added_by'
        db.add_column('people_eventlocation', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'OrganisationAssociatedSource.date_created'
        db.add_column('people_organisationassociatedsource', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'OrganisationAssociatedSource.date_modified'
        db.add_column('people_organisationassociatedsource', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'OrganisationAssociatedSource.added_by'
        db.add_column('people_organisationassociatedsource', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PersonAssociatedPerson.date_created'
        db.add_column('people_personassociatedperson', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedPerson.date_modified'
        db.add_column('people_personassociatedperson', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 29, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedPerson.added_by'
        db.add_column('people_personassociatedperson', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonAssociatedSource.date_created'
        db.delete_column('people_personassociatedsource', 'date_created')

        # Deleting field 'PersonAssociatedSource.date_modified'
        db.delete_column('people_personassociatedsource', 'date_modified')

        # Deleting field 'PersonAssociatedSource.added_by'
        db.delete_column('people_personassociatedsource', 'added_by_id')

        # Deleting field 'PersonAddress.date_created'
        db.delete_column('people_personaddress', 'date_created')

        # Deleting field 'PersonAddress.date_modified'
        db.delete_column('people_personaddress', 'date_modified')

        # Deleting field 'PersonAddress.added_by'
        db.delete_column('people_personaddress', 'added_by_id')

        # Deleting field 'EventLocation.date_created'
        db.delete_column('people_eventlocation', 'date_created')

        # Deleting field 'EventLocation.date_modified'
        db.delete_column('people_eventlocation', 'date_modified')

        # Deleting field 'EventLocation.added_by'
        db.delete_column('people_eventlocation', 'added_by_id')

        # Deleting field 'OrganisationAssociatedSource.date_created'
        db.delete_column('people_organisationassociatedsource', 'date_created')

        # Deleting field 'OrganisationAssociatedSource.date_modified'
        db.delete_column('people_organisationassociatedsource', 'date_modified')

        # Deleting field 'OrganisationAssociatedSource.added_by'
        db.delete_column('people_organisationassociatedsource', 'added_by_id')

        # Deleting field 'PersonAssociatedPerson.date_created'
        db.delete_column('people_personassociatedperson', 'date_created')

        # Deleting field 'PersonAssociatedPerson.date_modified'
        db.delete_column('people_personassociatedperson', 'date_modified')

        # Deleting field 'PersonAssociatedPerson.added_by'
        db.delete_column('people_personassociatedperson', 'added_by_id')
