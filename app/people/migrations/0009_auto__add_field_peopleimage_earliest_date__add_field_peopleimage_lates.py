...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeopleImage.earliest_date'
        db.add_column('people_peopleimage', 'earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PeopleImage.latest_date'
        db.add_column('people_peopleimage', 'latest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PeopleStory.created_by'
        db.delete_column('people_peoplestory', 'created_by_id')

        # Deleting field 'PeopleStory.date_created'
        db.delete_column('people_peoplestory', 'date_created')

        # Adding field 'PeopleStory.added_by'
        db.add_column('people_peoplestory', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PeopleStory.date_added'
        db.add_column('people_peoplestory', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeopleImage.earliest_date'
        db.delete_column('people_peopleimage', 'earliest_date')

        # Deleting field 'PeopleImage.latest_date'
        db.delete_column('people_peopleimage', 'latest_date')

        # Adding field 'PeopleStory.created_by'
        db.add_column('people_peoplestory', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2012, 11, 8, 0, 0), to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PeopleStory.date_created'
        db.add_column('people_peoplestory', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 8, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'PeopleStory.added_by'
        db.delete_column('people_peoplestory', 'added_by_id')

        # Deleting field 'PeopleStory.date_added'
        db.delete_column('people_peoplestory', 'date_added')
