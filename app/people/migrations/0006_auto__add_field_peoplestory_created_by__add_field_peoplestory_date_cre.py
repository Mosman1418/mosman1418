...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_peoplestory', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 6, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PeopleStory.date_modified'
        db.add_column('people_peoplestory', 'date_modified',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PeopleStory.date_modified'
        db.delete_column('people_peoplestory', 'date_modified')
