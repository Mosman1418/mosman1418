...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventAssociation'
        db.create_table('people_eventassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('inverse_label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('people', ['EventAssociation'])

        # Adding M2M table for field rdf_property on 'EventAssociation'
        db.create_table('people_eventassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventassociation', models.ForeignKey(orm['people.eventassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('people_eventassociation_rdf_property', ['eventassociation_id', 'rdfproperty_id'])

        # Adding model 'OrgAssociation'
        db.create_table('people_orgassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('inverse_label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('people', ['OrgAssociation'])

        # Adding M2M table for field rdf_property on 'OrgAssociation'
        db.create_table('people_orgassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('orgassociation', models.ForeignKey(orm['people.orgassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('people_orgassociation_rdf_property', ['orgassociation_id', 'rdfproperty_id'])

        # Adding model 'ObjectAssociation'
        db.create_table('people_objectassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('inverse_label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('people', ['ObjectAssociation'])

        # Adding M2M table for field rdf_property on 'ObjectAssociation'
        db.create_table('people_objectassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('objectassociation', models.ForeignKey(orm['people.objectassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('people_objectassociation_rdf_property', ['objectassociation_id', 'rdfproperty_id'])

        # Adding model 'SourceAssociation'
        db.create_table('people_sourceassociation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('inverse_label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('people', ['SourceAssociation'])

        # Adding M2M table for field rdf_property on 'SourceAssociation'
        db.create_table('people_sourceassociation_rdf_property', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sourceassociation', models.ForeignKey(orm['people.sourceassociation'], null=False)),
            ('rdfproperty', models.ForeignKey(orm['linkeddata.rdfproperty'], null=False))
        ))
        db.create_unique('people_sourceassociation_rdf_property', ['sourceassociation_id', 'rdfproperty_id'])


        # Changing field 'PersonAssociatedEvent.association'
        db.alter_column('people_personassociatedevent', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.EventAssociation']))
        # Adding field 'PersonAssociation.inverse_label'
        db.add_column('people_personassociation', 'inverse_label',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'PersonAssociatedOrganisation.association'
        db.alter_column('people_personassociatedorganisation', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.OrgAssociation']))

        # Changing field 'PersonAssociatedSource.association'
        db.alter_column('people_personassociatedsource', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.SourceAssociation']))
        # Adding field 'PersonRole.inverse_label'
        db.add_column('people_personrole', 'inverse_label',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'OrganisationAssociatedSource.association'
        db.alter_column('people_organisationassociatedsource', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.SourceAssociation']))
        # Adding field 'EventLocationAssociation.inverse_label'
        db.add_column('people_eventlocationassociation', 'inverse_label',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventAssociation'
        db.delete_table('people_eventassociation')

        # Removing M2M table for field rdf_property on 'EventAssociation'
        db.delete_table('people_eventassociation_rdf_property')

        # Deleting model 'OrgAssociation'
        db.delete_table('people_orgassociation')

        # Removing M2M table for field rdf_property on 'OrgAssociation'
        db.delete_table('people_orgassociation_rdf_property')

        # Deleting model 'ObjectAssociation'
        db.delete_table('people_objectassociation')

        # Removing M2M table for field rdf_property on 'ObjectAssociation'
        db.delete_table('people_objectassociation_rdf_property')

        # Deleting model 'SourceAssociation'
        db.delete_table('people_sourceassociation')

        # Removing M2M table for field rdf_property on 'SourceAssociation'
        db.delete_table('people_sourceassociation_rdf_property')


        # Changing field 'PersonAssociatedEvent.association'
        db.alter_column('people_personassociatedevent', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.PersonAssociation']))
        # Deleting field 'PersonAssociation.inverse_label'
        db.delete_column('people_personassociation', 'inverse_label')


        # Changing field 'PersonAssociatedOrganisation.association'
        db.alter_column('people_personassociatedorganisation', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.PersonAssociation']))

        # Changing field 'PersonAssociatedSource.association'
        db.alter_column('people_personassociatedsource', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.PersonAssociation']))
        # Deleting field 'PersonRole.inverse_label'
        db.delete_column('people_personrole', 'inverse_label')


        # Changing field 'OrganisationAssociatedSource.association'
        db.alter_column('people_organisationassociatedsource', 'association_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.PersonAssociation']))
        # Deleting field 'EventLocationAssociation.inverse_label'
        db.delete_column('people_eventlocationassociation', 'inverse_label')
    ...
    models = {
        ...
        'people.personassociatedorganisation': {
            ...
            'association': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.OrgAssociation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organisation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Organisation']"}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']"})
        },
