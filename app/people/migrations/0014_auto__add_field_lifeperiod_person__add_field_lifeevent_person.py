...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LifePeriod.person'
        db.add_column('people_lifeperiod', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['people.Person']),
                      keep_default=False)

        # Adding field 'LifeEvent.person'
        db.add_column('people_lifeevent', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['people.Person']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LifePeriod.person'
        db.delete_column('people_lifeperiod', 'person_id')

        # Deleting field 'LifeEvent.person'
        db.delete_column('people_lifeevent', 'person_id')
