...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeopleImage.added_by'
        db.add_column('people_peopleimage', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PeopleImage.date_added'
        db.add_column('people_peopleimage', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 7, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PeopleImage.date_modified'
        db.add_column('people_peopleimage', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeopleImage.added_by'
        db.delete_column('people_peopleimage', 'added_by_id')

        # Deleting field 'PeopleImage.date_added'
        db.delete_column('people_peopleimage', 'date_added')

        # Deleting field 'PeopleImage.date_modified'
        db.delete_column('people_peopleimage', 'date_modified')
