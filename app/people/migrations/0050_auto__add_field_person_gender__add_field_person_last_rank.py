...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('people_person', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Person.last_rank'
        db.add_column('people_person', 'last_rank',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('people_person', 'gender')

        # Deleting field 'Person.last_rank'
        db.delete_column('people_person', 'last_rank')
