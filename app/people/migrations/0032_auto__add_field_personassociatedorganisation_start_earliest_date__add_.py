...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAssociatedOrganisation.start_earliest_date'
        db.add_column('people_personassociatedorganisation', 'start_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedOrganisation.start_earliest_month'
        db.add_column('people_personassociatedorganisation', 'start_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAssociatedOrganisation.start_earliest_day'
        db.add_column('people_personassociatedorganisation', 'start_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAssociatedOrganisation.end_earliest_date'
        db.add_column('people_personassociatedorganisation', 'end_earliest_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonAssociatedOrganisation.end_earliest_month'
        db.add_column('people_personassociatedorganisation', 'end_earliest_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PersonAssociatedOrganisation.end_earliest_day'
        db.add_column('people_personassociatedorganisation', 'end_earliest_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field sources on 'PersonAssociatedOrganisation'
        db.create_table('people_personassociatedorganisation_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personassociatedorganisation', models.ForeignKey(orm['people.personassociatedorganisation'], null=False)),
            ('source', models.ForeignKey(orm['sources.source'], null=False))
        ))
        db.create_unique('people_personassociatedorganisation_sources', ['personassociatedorganisation_id', 'source_id'])


    def backwards(self, orm):
        # Deleting field 'PersonAssociatedOrganisation.start_earliest_date'
        db.delete_column('people_personassociatedorganisation', 'start_earliest_date')

        # Deleting field 'PersonAssociatedOrganisation.start_earliest_month'
        db.delete_column('people_personassociatedorganisation', 'start_earliest_month')

        # Deleting field 'PersonAssociatedOrganisation.start_earliest_day'
        db.delete_column('people_personassociatedorganisation', 'start_earliest_day')

        # Deleting field 'PersonAssociatedOrganisation.end_earliest_date'
        db.delete_column('people_personassociatedorganisation', 'end_earliest_date')

        # Deleting field 'PersonAssociatedOrganisation.end_earliest_month'
        db.delete_column('people_personassociatedorganisation', 'end_earliest_month')

        # Deleting field 'PersonAssociatedOrganisation.end_earliest_day'
        db.delete_column('people_personassociatedorganisation', 'end_earliest_day')

        # Removing M2M table for field sources on 'PersonAssociatedOrganisation'
        db.delete_table('people_personassociatedorganisation_sources')
